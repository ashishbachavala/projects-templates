...
const features = [
  'Unlock the full signed-in workspace',
  'Keep access without a recurring plan',
  'Use the starter as a paid-gated product shell',
  'Adapt the offer, copy, and product flow to your own app',
  'Preserve the same provider wiring across auth, data, and hosting',
];
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-lg flex-col items-center justify-center px-4 pb-12 pt-12">
        <div className="w-full rounded-2xl border border-white/80 bg-white/80 p-8 shadow-[0_24px_80px_rgba(15,23,42,0.14)] backdrop-blur-xl">
          ...
          <h1 className="mt-2 text-2xl font-semibold tracking-tight text-neutral-950">
            Next.js One-time Payment Cloudflare Starter
          </h1>
          ...
          <div className="mt-6 flex items-baseline gap-1">
            ...
            <span className="text-base text-neutral-500">one time</span>
          </div>
          ...
          <div className="mt-8">
            {authContext.userId ? (
              <CheckoutButton label={`Unlock access \u2014 $10.00`} />
            ) : (
