                  ...
                  <div className="overflow-x-auto px-4 pb-4">
                    <div className="w-full min-w-3xl overflow-hidden rounded-md border border-neutral-950/6 text-sm sm:min-w-4xl sm:text-base">
                      ...
                      {[
                        ...
                        { label: 'Dashboard', path: '/dashboard', description: 'Unlocked workspace', services: [{ label: "Render Postgres", icon: "https://render.com/favicon.ico" }] },
                  ...
                  <div className="p-6">
                    <div className="relative">
                      ...
                      <p className="mb-3 text-balance text-neutral-600">
                        Render Postgres stores users, purchases, and application data for your app.
                      </p>
                    </div>
                    <div className="flex items-center gap-1 font-medium">
                      View on Render
