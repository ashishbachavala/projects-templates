                  ...
                  <div className="overflow-x-auto px-4 pb-4">
                    <div className="w-full min-w-3xl overflow-hidden rounded-md border border-neutral-950/6 text-sm sm:min-w-4xl sm:text-base">
                      ...
                      {[
                        ...
                        { label: 'Dashboard', path: '/dashboard', description: 'Your app\'s home base', services: [{ label: "Render Postgres", icon: "https://render.com/favicon.ico" }] },
            ...
            <li className="relative sm:col-span-2 md:col-span-3">
              {databaseDashboardUrl ? (
                ...
                >
                  <div className="p-6">
                    <div className="relative">
                      <img alt="" className="inline-block h-8 w-8 rounded-sm" src="https://render.com/favicon.ico" />
                      <div className="mb-1.5 mt-3 flex items-center gap-2">
                        <h3 className="text-lg font-medium text-neutral-950">Render Postgres</h3>
                      ...
                      <p className="mb-3 text-balance text-neutral-600">
                        Render Postgres stores users, subscriptions, and application data for your app.
                      </p>
                    </div>
                    <div className="flex items-center gap-1 font-medium">
                      View on Render
