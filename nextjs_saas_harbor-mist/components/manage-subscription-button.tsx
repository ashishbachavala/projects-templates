...
export function ManageSubscriptionButton({
  ...
  const buttonClassName =
    variant === 'secondary'
      ? secondaryButton
      : 'group inline-flex cursor-pointer items-center gap-1.5 rounded-md px-2.5 py-1.5 text-sm font-medium text-neutral-600 transition-all duration-200 hover:bg-white/50 hover:text-neutral-900 disabled:cursor-not-allowed disabled:opacity-60';
